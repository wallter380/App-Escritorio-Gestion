...
class Venta:
    def __init__(self, root_win):
        ...
        # title
        title = Label(self.root, text="Facturas de venta", font=("Lato", 14, "normal"), bg="#2EB086", fg="white")
        title.place(x=50, y=20, width=1000)

        invoice_label = Label(self.root, text="Factura No.", font=("Lato", 14, "normal"), bg="white")
        ...
        search_btn = Button(self.root, text="Buscar", command=self.search, font=("Lato", 14, "normal"), bg="#2EB086", fg="white", bd=0, cursor="hand2")
        search_btn.place(x=400, y=80, width=120, height=28)
        clear_btn = Button(self.root, text="Borrar", command=self.clear, font=("Lato", 14, "normal"), bg="#313552", fg="white", bd=0, cursor="hand2")
        ...
        title_bill = Label(bill_frame, text="Visualización de facturas", font=("Lato", 14, "normal"), bg="#2EB086", fg="white")
    ...
    def search(self):
        if self.invoice_var.get() == "":
            messagebox.showerror("Error", "¡Número de factura requerido!", parent=self.root)
        else:
            if self.invoice_var.get() in self.bills_list:
                ...
                messagebox.showerror("Error", "¡Factura no existente!", parent=self.root)
